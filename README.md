...
- Optional hardening: set `OFFLINE_LOCKDOWN=true` to disable outbound network features (skills pack sync/install from remote sources and souls.directory fetches).
